...
.owl-carousel .owl-item {
    display: flex !important;
    transition: transform 0.5s cubic-bezier(0.2, 0.9, 0.3, 1), opacity 0.5s ease !important;
...
.owl-carousel .owl-item .blog-card {
    ...
    transition: transform 0.4s cubic-bezier(0.2, 0.9, 0.3, 1), box-shadow 0.4s ease !important;
}
.owl-carousel .owl-item.active .single-item,
.owl-carousel .owl-item.active .team-card-unified,
.owl-carousel .owl-item.active .impact-card,
.owl-carousel .owl-item.active .blog-card {
    transform: translateY(0) scale(1.0) !important;
    box-shadow: 0 12px 28px rgba(0, 46, 91, 0.12) !important;
}
.owl-dots {
    text-align: center;
    margin-top: 16px;
...
@media (max-width: 991px) {
    ...
    .row.services-auto-carousel,
    .row.team-auto-carousel,
    .row.track-record-auto-carousel,
    .row.blogs-auto-carousel {
...
/* ==========================================================================
   CINEMATIC SCENE PROGRESSIVE REVEAL SYSTEM (SMOOTH MOVIE-LIKE SCROLL ANIMATIONS)
   ========================================================================== */
.cinematic-scene {
    opacity: 0;
...
.cinematic-scene.is-revealed {
    opacity: 1 !important;
    transform: translateY(0) scale(1) !important;
}

/* STAGGERED REVEAL FOR HEADINGS, BADGES, AND CARDS */
.cinematic-scene .service-badge,
.cinematic-scene h2,
.cinematic-scene p.text-muted,
.cinematic-scene .single-item,
.cinematic-scene .team-card-unified,
.cinematic-scene .impact-card,
.cinematic-scene .blog-card,
.cinematic-scene .google-badge-box,
.cinematic-scene .review-card-item {
    opacity: 0;
    transform: translateY(24px);
    transition: opacity 0.7s cubic-bezier(0.16, 1, 0.3, 1), transform 0.7s cubic-bezier(0.16, 1, 0.3, 1);
}

.cinematic-scene.is-revealed .service-badge {
    opacity: 1 !important;
    transform: translateY(0) !important;
    transition-delay: 0.06s;
}

.cinematic-scene.is-revealed h2 {
    opacity: 1 !important;
    transform: translateY(0) !important;
    transition-delay: 0.12s;
}

.cinematic-scene.is-revealed p.text-muted {
    opacity: 1 !important;
    transform: translateY(0) !important;
    transition-delay: 0.18s;
}

.cinematic-scene.is-revealed .single-item,
.cinematic-scene.is-revealed .team-card-unified,
.cinematic-scene.is-revealed .impact-card,
.cinematic-scene.is-revealed .blog-card,
.cinematic-scene.is-revealed .google-badge-box,
.cinematic-scene.is-revealed .review-card-item {
    opacity: 1 !important;
    transform: translateY(0) !important;
}

/* Child stagger animation */
.cinematic-scene.is-revealed .col-lg-4:nth-child(1) .single-item,
.cinematic-scene.is-revealed .col-lg-3:nth-child(1) .team-card-unified,
.cinematic-scene.is-revealed .col-lg-3:nth-child(1) .impact-card,
.cinematic-scene.is-revealed .col-lg-4:nth-child(1) .blog-card {
    transition-delay: 0.16s;
}

.cinematic-scene.is-revealed .col-lg-4:nth-child(2) .single-item,
.cinematic-scene.is-revealed .col-lg-3:nth-child(2) .team-card-unified,
.cinematic-scene.is-revealed .col-lg-3:nth-child(2) .impact-card,
.cinematic-scene.is-revealed .col-lg-4:nth-child(2) .blog-card {
    transition-delay: 0.28s;
}

.cinematic-scene.is-revealed .col-lg-4:nth-child(3) .single-item,
.cinematic-scene.is-revealed .col-lg-3:nth-child(3) .team-card-unified,
.cinematic-scene.is-revealed .col-lg-3:nth-child(3) .impact-card,
.cinematic-scene.is-revealed .col-lg-4:nth-child(3) .blog-card {
    transition-delay: 0.40s;
}

.cinematic-scene.is-revealed .col-lg-4:nth-child(4) .single-item,
.cinematic-scene.is-revealed .col-lg-3:nth-child(4) .team-card-unified,
.cinematic-scene.is-revealed .col-lg-3:nth-child(4) .impact-card {
    transition-delay: 0.52s;
}

.cinematic-scene.is-revealed .col-lg-4:nth-child(5) .single-item {
    transition-delay: 0.64s;
}

.cinematic-scene.is-revealed .col-lg-4:nth-child(6) .single-item {
...
home_body = f"""
    ...
    <!-- TRUSTED BY (ANIMATED COUNTERS SECTION MATCHING LIVE CANATASHA.COM) -->
    <section class="py-5 cinematic-scene" id="trusted-stats-section" style="background-color: #ffffff;">
        <div class="container">
            <h2 class="text-center font-weight-bold mb-4" style="color: #64748b; font-size: 40px; letter-spacing: -0.5px;">Trusted By</h2>
            <div class="p-4 p-md-5 rounded shadow-sm" style="background: #475569; color: #ffffff; border-radius: 12px;">
                <div class="row text-center align-items-center">
                    <!-- Stat 1 -->
                    <div class="col-lg-3 col-6 mb-4 mb-lg-0">
                        <h1 class="font-weight-bold text-white mb-1" style="font-size: 48px; font-family: 'Poppins', sans-serif;">
                            <span class="counter-val" data-target="4000" data-suffix="+">4000+</span>
                        </h1>
                        <p class="text-uppercase text-white font-weight-bold mb-0" style="letter-spacing: 1.5px; font-size: 13px; opacity: 0.95;">HAPPY CLIENTS</p>
                    </div>

                    <!-- Stat 2 -->
                    <div class="col-lg-3 col-6 mb-4 mb-lg-0">
                        <h1 class="font-weight-bold text-white mb-1" style="font-size: 48px; font-family: 'Poppins', sans-serif;">
                            <span class="counter-val" data-target="50" data-suffix="+">50+</span>
                        </h1>
                        <p class="text-uppercase text-white font-weight-bold mb-0" style="letter-spacing: 1.5px; font-size: 13px; opacity: 0.95;">STARTUP COMPANIES</p>
                    </div>

                    <!-- Stat 3 -->
                    <div class="col-lg-3 col-6">
                        <h1 class="font-weight-bold text-white mb-1" style="font-size: 48px; font-family: 'Poppins', sans-serif;">
                            <span class="counter-val" data-target="40" data-suffix="+">40+</span>
                        </h1>
                        <p class="text-uppercase text-white font-weight-bold mb-0" style="letter-spacing: 1.5px; font-size: 13px; opacity: 0.95;">CITIES</p>
                    </div>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <p class="text-uppercase text-white font-weight-bold mb-0" style="letter-spacing: 1.5px; font-size: 13px; opacity: 0.95;">EMPLOYERS</p>
                    </div>
                </div>
            </div>
        </div>
...
__BODY_CONTENT__
    ...
    <div class="modal fade" id="consultationModal" tabindex="-1" role="dialog" aria-labelledby="consultModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
                <div class="modal-header text-white d-flex justify-content-between align-items-center" style="background: var(--ca-primary, #006B63); border: none; padding: 14px 20px;">
                    <h5 class="modal-title font-weight-bold mb-0" id="consultModalLabel"><i class="fa fa-calendar-check-o mr-2"></i> Book CA Consultation</h5>
                    <button type="button" class="close text-white" data-dismiss="modal" onclick="$('#consultationModal').modal('hide');" aria-label="Close" style="opacity: 1; cursor: pointer !important; font-size: 30px; font-weight: 300; background: transparent; border: none; outline: none; padding: 4px 8px; line-height: 1; position: relative; z-index: 999999; pointer-events: auto !important;">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '[data-dismiss="modal"], #consultationModal .close', function(e){
                e.preventDefault();
                $('#consultationModal').modal('hide');
            });
            ...
            // MULTI-SECTION AUTO ZOOM & SLIDE CAROUSEL ENGINE (MOBILE ONLY < 992px - FAST & SNAPPY)
            function initMobileOnlyCarousels() {
                var isMobile = $(window).width() < 992;
                
                var mobileCarousels = [
                    { selector: '.services-auto-carousel', interval: 2500 },
                    { selector: '.team-auto-carousel', interval: 2600 },
                    { selector: '.track-record-auto-carousel', interval: 2500 },
                    { selector: '.blogs-auto-carousel', interval: 2700 }
                ];
            ...
            // REVIEWS CAROUSEL (ALWAYS ACTIVE ON BOTH MOBILE & DESKTOP - FAST 2700ms)
            if ($(".reviews-carousel").length) {
                ...
                setInterval(function(){
                    if ($revCarousel.length) {
                        $revCarousel.trigger('next.owl.carousel', [500]);
                    }
                }, 2700);
            }
            ...
            // CINEMATIC SCENE PROGRESSIVE REVEAL CONTROLLER (FADE-IN & ZOOM-IN ON SCROLL)
            function initCinematicScroll() {
                var scenes = document.querySelectorAll('.cinematic-scene');
                if (!scenes.length) return;

                function checkReveal() {
                    var triggerPoint = (window.innerHeight || document.documentElement.clientHeight) * 0.90;
                    scenes.forEach(function(scene) {
                        var rect = scene.getBoundingClientRect();
                        if (rect.top < triggerPoint && rect.bottom > 40) {
                ...
                if ('IntersectionObserver' in window) {
                    ...
                    scenes.forEach(function(s) {
                        sceneObserver.observe(s);
                    });
                }

                window.addEventListener('scroll', checkReveal, { passive: true });
                window.addEventListener('touchmove', checkReveal, { passive: true });
                checkReveal();
                
                // Immediately reveal first two scenes
                if (scenes.length > 0) scenes[0].classList.add('is-revealed');
                if (scenes.length > 1) setTimeout(function(){ scenes[1].classList.add('is-revealed'); }, 120);
            }
            initCinematicScroll();

            // ROBUST COUNT-UP ANIMATION FOR TRUSTED BY SECTION (DESKTOP & MOBILE)
            function initCounterAnimation() {
                var statsSec = document.getElementById('trusted-stats-section');
                if (!statsSec) return;
                ...
                function runCountUp() {
                    if (animated) return;
                    var rect = statsSec.getBoundingClientRect();
                ...
                window.addEventListener('touchmove', runCountUp, { passive: true });
                runCountUp();
